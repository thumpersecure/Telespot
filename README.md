# Telespot
Phone OSINT lookup using DDGR and pattern recognition 
...
```bash
# Download all files
wget https://path/to/telespot.py
wget https://path/to/requirements.txt
wget https://path/to/setup.sh
...
wget https://path/to/requirements.txt
# or
git clone https://github.com/yourusername/telespot.git
cd telespot
```
...
wget https://path/to/telespot.py
# or
curl -O https://path/to/telespot.py
```
...
Created for legal marketing and investigative purposes. Particularly useful for:
...
Free to use and modify for legitimate purposes.
